...
-- ----------------------------
-- Sequence structure for sys_data_dict_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "sys_data_dict_id_seq";
CREATE SEQUENCE "sys_data_dict_id_seq" 
INCREMENT 1
MINVALUE  1
...
-- ----------------------------
-- Sequence structure for sys_dep_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "sys_dep_id_seq";
CREATE SEQUENCE "sys_dep_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
-- ----------------------------
-- Sequence structure for sys_dep_user_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "sys_dep_user_id_seq";
CREATE SEQUENCE "sys_dep_user_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
-- ----------------------------
DROP SEQUENCE IF EXISTS "sys_log_id_seq";
...
CREATE TABLE "sys_data_dict" (
  "id" int8 NOT NULL DEFAULT nextval('sys_data_dict_id_seq'::regclass),
...
;
COMMENT ON COLUMN "sys_data_dict"."id" IS '主键';
COMMENT ON COLUMN "sys_data_dict"."dict_name" IS '数据字典名称';
COMMENT ON COLUMN "sys_data_dict"."description" IS '描述';
COMMENT ON COLUMN "sys_data_dict"."create_time" IS '创建时间';
COMMENT ON COLUMN "sys_data_dict"."update_time" IS '更新时间';
COMMENT ON COLUMN "sys_data_dict"."create_by" IS '创建人';
COMMENT ON COLUMN "sys_data_dict"."update_by" IS '更新人';
...
CREATE TABLE "sys_dep" (
  "id" int8 NOT NULL DEFAULT nextval('sys_dep_id_seq'::regclass),
  "parent_id" int8,
...
;
COMMENT ON COLUMN "sys_dep"."id" IS '主键';
COMMENT ON COLUMN "sys_dep"."parent_id" IS '父节点';
COMMENT ON COLUMN "sys_dep"."department_name" IS '部门名称';
COMMENT ON COLUMN "sys_dep"."sort" IS '排序';
COMMENT ON COLUMN "sys_dep"."create_time" IS '创建时间';
COMMENT ON COLUMN "sys_dep"."update_time" IS '更新时间';
COMMENT ON COLUMN "sys_dep"."create_by" IS '创建人';
COMMENT ON COLUMN "sys_dep"."update_by" IS '更新人';
COMMENT ON TABLE "sys_dep" IS '部门表';
...
CREATE TABLE "sys_dep_user" (
  "id" int8 NOT NULL DEFAULT nextval('sys_dep_user_id_seq'::regclass),
  "dep_id" int8,
  "user_id" int8
)
;
COMMENT ON COLUMN "sys_dep_user"."id" IS '主键';
COMMENT ON COLUMN "sys_dep_user"."dep_id" IS '部门编号';
COMMENT ON COLUMN "sys_dep_user"."user_id" IS '用户编号';
COMMENT ON TABLE "sys_dep_user" IS '部门用户关联表';
...
COMMENT ON COLUMN "sys_log"."ipaddress" IS 'ip地址';
COMMENT ON COLUMN "sys_log"."oprator" IS '操作';
COMMENT ON COLUMN "sys_log"."usage_time" IS '耗时';
...
INSERT INTO "sys_log" VALUES (4070, 'admin', '0:0:0:0:0:0:0:1', '用户登陆', '1', '2020-11-25 10:22:23');
INSERT INTO "sys_log" VALUES (4071, 'admin', '0:0:0:0:0:0:0:1', '更新:修改用户', '15', '2020-11-25 10:22:33');
INSERT INTO "sys_log" VALUES (4072, 'admin', '0:0:0:0:0:0:0:1', '用户登陆', '1', '2021-02-18 09:32:05');
INSERT INTO "sys_log" VALUES (4073, 'admin', '0:0:0:0:0:0:0:1', '更新:添加修改用户角色', '10', '2021-02-18 09:32:49');
COMMIT;
...
;
COMMENT ON COLUMN "sys_menu"."id" IS '菜单编号';
COMMENT ON COLUMN "sys_menu"."path" IS '菜单路径';
COMMENT ON COLUMN "sys_menu"."name" IS '菜单名称';
COMMENT ON COLUMN "sys_menu"."permission" IS '菜单权限';
COMMENT ON COLUMN "sys_menu"."icon_cls" IS '菜单图标';
COMMENT ON COLUMN "sys_menu"."component" IS '菜单组件';
...
;
COMMENT ON COLUMN "sys_role"."id" IS '角色编号';
...
COMMENT ON COLUMN "sys_role_menu"."rid" IS '角色编号';
COMMENT ON COLUMN "sys_role_menu"."mid" IS '菜单编号';
...
COMMENT ON COLUMN "sys_user"."telephone" IS '电话';
...
-- ----------------------------
BEGIN;
INSERT INTO "sys_user" VALUES (2, 'test', '29620b0d687aa74d5ee390c78886fd61', 'wkt/YpURlzZ+dqVBMy9YRQ==', 'test@boot.com', '测试用户', '2020-10-10 10:58:42', '2020-09-16 10:25:14', '13170072060', 't', 'admin', NULL);
INSERT INTO "sys_user" VALUES (1, 'admin', 'c87786626c309e4bda28a5d06ef71aab', 'eWrjErrosi9X9H/6wv8WFg==', 'admin@boot.com', '管理员', '2020-09-16 10:15:14', '2020-10-24 14:34:13', '13170072060', 't', 'admin', NULL);
INSERT INTO "sys_user" VALUES (8, 'test2', '1d87dc8f9223b44a807ca8d7f7367d8b', '3N3giOCcU/iX7hZXVLl3ZA==', 'test2@zboot', 'test2a', '2020-10-24 20:30:20', '2020-10-29 14:12:18', '1256895', 'f', 'admin', NULL);
INSERT INTO "sys_user" VALUES (3, 'dev', '0ad2ecc65d3532731b8f768f024ecda2', 'an0her4dqTWiVQJDIwSDRA==', 'dev@boot.com', '开发人员', '2020-09-16 12:06:52', '2020-11-25 10:22:33', '45369875', 't', 'admin', 'admin');
COMMIT;
...
COMMENT ON COLUMN "sys_user_role"."uid" IS '用户编号';
COMMENT ON COLUMN "sys_user_role"."rid" IS '角色编号';
...
-- ----------------------------
ALTER SEQUENCE "sys_data_dict_id_seq"
OWNED BY "sys_data_dict"."id";
SELECT setval('"sys_data_dict_id_seq"', 4, true);
ALTER SEQUENCE "sys_dep_id_seq"
OWNED BY "sys_dep"."id";
SELECT setval('"sys_dep_id_seq"', 10, true);
ALTER SEQUENCE "sys_dep_user_id_seq"
OWNED BY "sys_dep_user"."id";
SELECT setval('"sys_dep_user_id_seq"', 6, true);
ALTER SEQUENCE "sys_log_id_seq"
OWNED BY "sys_log"."id";
SELECT setval('"sys_log_id_seq"', 4074, true);
ALTER SEQUENCE "sys_menu_id_seq"
OWNED BY "sys_menu"."id";
SELECT setval('"sys_menu_id_seq"', 42, true);
ALTER SEQUENCE "sys_role_id_seq"
OWNED BY "sys_role"."id";
SELECT setval('"sys_role_id_seq"', 5, true);
ALTER SEQUENCE "sys_role_menu_id_seq"
OWNED BY "sys_role_menu"."id";
SELECT setval('"sys_role_menu_id_seq"', 209, true);
ALTER SEQUENCE "sys_user_id_seq"
OWNED BY "sys_user"."id";
SELECT setval('"sys_user_id_seq"', 10, true);
ALTER SEQUENCE "sys_user_role_id_seq"
OWNED BY "sys_user_role"."id";
SELECT setval('"sys_user_role_id_seq"', 14, true);

-- ----------------------------
-- Primary Key structure for table sys_data_dict
-- ----------------------------
ALTER TABLE "sys_data_dict" ADD CONSTRAINT "sys_data_dict_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_dep
-- ----------------------------
ALTER TABLE "sys_dep" ADD CONSTRAINT "sys_dep_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_dep_user
-- ----------------------------
ALTER TABLE "sys_dep_user" ADD CONSTRAINT "sys_dep_user_pkey" PRIMARY KEY ("id");
